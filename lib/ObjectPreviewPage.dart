...
class ObjectPreviewPage extends StatefulWidget {
  ObjectPreviewPage(this.file, this.vision, {super.key});
  XFile file;
...
class _ObjectPreviewPageState extends State<ObjectPreviewPage> {
          ...
          children: [
            ...
            Container(
              ...
              child: SingleChildScrollView(
                ...
                child: Text(
                  yoloResults.isEmpty
                      ? 'Rất tiếc, tôi không thể nhận diện bất kỳ vật thể nào từ bức ảnh bạn vừa chụp, bạn có thể thử chụp một bức ảnh khác để xem liệu tôi có thể nhận diện được vật thể nào không'
                      : '${translate_text}',
                  style: TextStyle(
                    fontSize: 20.0,
  ...
  Future<String> translated() async {
    ...
    if (yoloResults.isEmpty) {
      speak(
          'Rất tiếc, chúng tôi không thể nhận diện bất kỳ vật thể nào từ bức ảnh bạn vừa chụp, bạn có thể thử chụp một bức ảnh khác để xem liệu tôi có thể nhận diện được vật thể nào không');
    } else {
  ...
  Future<void> loadYoloModel() async {
    await widget.vision.loadYoloModel(
        labels: 'assets/tflite/object_labels.txt',
        modelPath: 'assets/tflite/objects_float32.tflite',
        modelVersion: "yolov8",
        quantization: false,
        numThreads: 2,
        useGpu: false);
